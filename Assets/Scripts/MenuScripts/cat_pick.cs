...
public class Cat_pick : MonoBehaviour {
    ...
    {
        cat_count += 1;
        cats[0].GetComponent<CatController>().inTeam = true;
    }
    public void TaskOnClicktakecat1_1()
    {
        cat_count -= 1;
        cats[0].GetComponent<CatController>().inTeam = false;

    }
    public void TaskOnClicktakecat2()
    {
        cat_count += 1;
        cats[1].GetComponent<CatController>().inTeam = true;
    }
    public void TaskOnClicktakecat2_1()
    {
        cat_count -= 1;
        cats[1].GetComponent<CatController>().inTeam = false;
    }
    public void TaskOnClicktakecat3()
    {
        cat_count += 1;
        cats[2].GetComponent<CatController>().inTeam = true;
    }
    public void TaskOnClicktakecat3_1()
    {
        cat_count -= 1;
        cats[2].GetComponent<CatController>().inTeam = false;
    }
    public void TaskOnClicktakecat4()
    {
        cat_count += 1;
        cats[3].GetComponent<CatController>().inTeam = true;
    }
    public void TaskOnClicktakecat4_1()
    {
        cat_count -= 1;
        cats[3].GetComponent<CatController>().inTeam = false;
    }
    public void TaskOnClicktakecat5()
    {
        cat_count += 1;
        cats[4].GetComponent<CatController>().inTeam = true;
    }
    public void TaskOnClicktakecat5_1()
    {
        cat_count -= 1;
        cats[4].GetComponent<CatController>().inTeam = false;
    }
